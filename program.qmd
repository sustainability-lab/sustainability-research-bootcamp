...
**Tasks:**
1. Load and clean household power consumption data
2. Calculate daily, weekly, monthly statistics  
3. Find peak consumption patterns
4. Create normalized consumption metrics
5. Identify seasonal patterns using array operations
...
**Dataset:** [Beijing Air Quality Dataset](https://www.kaggle.com/datasets/sid321axn/beijing-multisite-airquality-data-set) or [OpenWeatherMap Air Pollution API](https://openweathermap.org/api/air-pollution)
...
### Public Datasets Used Throughout Program
1. **[UCI Power Consumption](https://archive.ics.uci.edu/ml/datasets/individual+household+electric+power+consumption):** Time series forecasting
2. **[Beijing Air Quality](https://www.kaggle.com/datasets/sid321axn/beijing-multisite-airquality-data-set):** Environmental data analysis
3. **[Smart City Data](https://www.kaggle.com/datasets/vineethakkinapalli/smart-city-iot-sensor-data):** Multi-modal sensor fusion
4. **[Solar Power Generation](https://www.kaggle.com/datasets/anikannal/solar-power-generation-data):** Renewable energy prediction
5. **[Indoor Air Quality](https://www.kaggle.com/datasets/yashvrdnjain/indoor-air-quality-monitoring):** Health risk classification
6. **[Environmental Research Papers](https://www.semanticscholar.org/):** Text analysis and NLP
...
### Essential Tools
- **Python 3.8+**, NumPy, Pandas, Matplotlib, Scikit-learn, PyTorch
