...
### 🏆 **Daily Assessment: Wine Quality Classification (120 minutes)**
**Dataset:** [UCI Wine Quality Dataset](https://archive.ics.uci.edu/ml/datasets/wine+quality)
**Challenge:**
1. Build classifier to predict wine quality (good vs bad)
2. Compare decision tree, random forest, and KNN performance
3. Use tree-based feature importance to find key factors
4. Create simple model interpretation plots
5. Handle class imbalance with basic techniques
6. Create simple prediction function
...
4. **[UCI Wine Quality](https://archive.ics.uci.edu/ml/datasets/wine+quality):** Classification practice
